...
public class BytebankApplication {
    ...
    private static void realizarTransferencia(){
        ...
        var valorTransferido = teclado.nextBigDecimal();

        service.realizarTransferencia(numeroDaContaOrigem, numeroDaContaDestino, valorTransferido);

        System.out.println("O valor de: " + valorTransferido + " foi para a conta de destino: " + numeroDaContaDestino);
        System.out.println("Pressione qualquer tecla e de ENTER para voltar ao menu principal");
        teclado.next();
